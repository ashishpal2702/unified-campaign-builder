...
-- Insert some sample contacts for demo
INSERT INTO public.contacts (user_id, name, email, phone, tags) VALUES
  ('00000000-0000-0000-0000-000000000000', 'John Doe', 'john@example.com', '+1234567890', ARRAY['vip', 'customer']),
  ('00000000-0000-0000-0000-000000000000', 'Jane Smith', 'jane@example.com', '+1234567891', ARRAY['prospect']),
  ('00000000-0000-0000-0000-000000000000', 'Mike Johnson', 'mike@example.com', '+1234567892', ARRAY['customer'])
